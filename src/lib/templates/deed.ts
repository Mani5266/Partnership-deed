...
// Ported from backend/docGenerator/index.js (443 lines) → TypeScript
// Generates a complete Partnership Deed as a Word document (.docx)
...
import type { GeneratePayload } from '@/lib/validation';
 ...
 * @param d - Validated form data
 * @returns The generated Word document as a Buffer
 */
